...
%\keywords{Query optimization; keyword2; keyword3}
...
We would like to thank the Apache Calcite community, contributors and users, who build, maintain, use, test, write about, and continue to push forward the Calcite project. Currently the committers to the project are Alan Gates, Aman Sinha, Ashutosh Chauhan, James R. Taylor, Jacques Nadeau, Jes\'us Camacho-Rodr\'iguez, Jinfeng Ni, John Pullokkaran, Josh Elser, Julian Hyde, Maryann Xue, Michael Mior, Milinda Pathirage, Nick Dimiduk, Steven Noels, Ted Dunning, and Vladimir Sitnikov.
